      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <p className="text-base text-[#5D5A53] mb-12">This is a sample site. Purchasing is disabled.</p>
            ...
            <div className="space-y-12">
              ...
              <div>
                ...
                <div className="space-y-4">
                   ...
                   <div className="flex items-center gap-2">
                     ...
                     <label htmlFor="newsletter" className="text-base text-[#5D5A53] cursor-not-allowed">Email me with news and offers</label>
                   </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="p-6 border border-[#D6D1C7] bg-white/50 space-y-4">
                   <p className="text-base text-[#5D5A53] mb-2">All transactions are secure and encrypted.</p>
              ...
              <div>
                <button 
                    disabled
                    className="w-full py-5 bg-[#A8A29E] text-[#F5F2EB] uppercase tracking-widest text-base font-medium cursor-not-allowed opacity-80"
                >
                    Pay Now — ${total}
                </button>
              </div>
            ...
            <div className="space-y-6 mb-8">
               {items.map((item, idx) => (
                 <div key={idx} className="flex gap-4">
                    ...
                    <span className="text-base text-[#5D5A53]">${item.price}</span>
                 </div>
               ))}
            </div>

            <div className="border-t border-[#D6D1C7] pt-6 space-y-2">
              <div className="flex justify-between text-base text-[#5D5A53]">
                 <span>Subtotal</span>
                 <span>${subtotal}</span>
              </div>
              <div className="flex justify-between text-base text-[#5D5A53]">
