      ...
      <div className="pt-24 md:pt-32 pb-12 md:pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32">
          <div className="p-8 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl hover:border-cyan-500/30 transition-colors shadow-sm dark:shadow-none">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">24/7 Uptime Monitor</h3>
          ...
          <div className="p-8 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl hover:border-green-500/30 transition-colors shadow-sm dark:shadow-none">
            <ShieldCheck className="w-10 h-10 text-green-400 mb-6" />
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Security & Firewall</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
          ...
          <div className="p-8 bg-white dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-2xl hover:border-blue-500/30 transition-colors shadow-sm dark:shadow-none">
            ...
            <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Daily Backups</h3>
            <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
        ...
        <div className="bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-12 flex flex-col md:flex-row items-center gap-12">
           <div className="md:w-2/3">
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Content Updates Included</h2>
        ...
        {/* COMPARISON TABLE */}
        <div className="mt-32">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12 text-center">At a Glance</h2>
            ...
            <table className="w-full text-left border-collapse min-w-[800px]">
              <thead>
                <tr>
                  ...
                  <th className="p-6 border-b border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-bold text-lg w-1/4">The Digital Keeper</th>
                  <th className="p-6 border-b border-cyan-500/30 text-cyan-600 dark:text-cyan-400 font-bold text-lg bg-cyan-100 dark:bg-cyan-900/10 rounded-t-2xl w-1/4 relative">
                    The Growth Partner
                  ...
                  <th className="p-6 border-b border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white font-bold text-lg w-1/4">The CTO Experience</th>
                </tr>
              </thead>
              <tbody className="text-sm text-slate-700 dark:text-slate-300">
                {[
                  ...
                  <tr key={i} className="group hover:bg-slate-100 dark:hover:bg-slate-900/30 transition-colors">
                    <td className="p-6 border-b border-slate-200 dark:border-slate-800/50 font-medium text-slate-600 dark:text-slate-400">{row.feature}</td>
                    <td className="p-6 border-b border-slate-200 dark:border-slate-800/50 font-mono">
                      {row.k.includes('❌') ? <span className="text-slate-500 dark:text-slate-600 flex items-center gap-2"><X size={14}/> {row.k.replace('❌ ', '')}</span> : 
                       row.k === 'Included' ? <span className="text-green-400 flex items-center gap-2"><Check size={14}/> Included</span> : row.k}
                    </td>
                    <td className="p-6 border-b border-slate-200 dark:border-slate-800/50 font-mono bg-cyan-50 dark:bg-cyan-900/5 text-cyan-800 dark:text-cyan-100 font-bold">
                      {row.g === 'Included' ? <span className="text-cyan-600 dark:text-cyan-400 flex items-center gap-2"><Check size={14}/> Included</span> : row.g}
                    </td>
                    <td className="p-6 border-b border-slate-200 dark:border-slate-800/50 font-mono">
