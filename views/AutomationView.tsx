      ...
      <div className="pt-24 md:pt-32 pb-12 md:pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="mb-32 relative">
            ...
            <div className="relative bg-slate-900/80 backdrop-blur-xl border border-white/10 rounded-[3rem] p-8 md:p-16 overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    <div>
                        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-400 text-xs font-black uppercase tracking-widest mb-8">
                        ...
                        <p className="text-slate-400 text-lg leading-relaxed mb-10 border-l-4 border-purple-500/50 pl-6">
                    ...
                    <div className="relative">
                         ...
                         <div className="bg-slate-950 border border-slate-800 rounded-3xl p-8 shadow-2xl relative z-10">
                            ...
                            <div className="space-y-4 font-mono text-xs">
                                <div className="flex gap-4 opacity-50">
                                    ...
                                    <span className="text-slate-300">Incoming Inquiry: "Price list?"</span>
                                </div>
                                <div className="flex gap-4 text-purple-300">
                                    <span className="text-purple-500 w-12">10:00</span>
                                    <span className="font-bold">Auto-Reply Triggered [Instant]</span>
                                </div>
                                <div className="flex gap-4 opacity-50">
                                    <span className="text-slate-500 w-12">10:01</span>
                                    <span className="text-slate-300">Client: "Okay, I want Package B"</span>
                                </div>
        ...
        <div className="mb-32">
            <div className="text-center mb-16">
                <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">Why Robots Win.</h2>
                <p className="text-slate-400 max-w-2xl mx-auto">
                    It's not about replacing humans. It's about removing the bottleneck.
                </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="p-8 bg-slate-900/30 border border-slate-800 rounded-3xl hover:border-purple-500/30 transition-all">
                    <Clock className="w-10 h-10 text-purple-400 mb-6" />
                    <h3 className="text-xl font-bold text-white mb-3">Speed Kills Competitors</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">
                ...
                <div className="p-8 bg-slate-900/30 border border-slate-800 rounded-3xl hover:border-pink-500/30 transition-all">
                    <CheckCircle2 className="w-10 h-10 text-pink-400 mb-6" />
                    <h3 className="text-xl font-bold text-white mb-3">Zero Bad Days</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">
                        Humans get tired, sick, and grumpy. AI Agents are polite, professional, and accurate 24 hours a day, 365 days a year.
                    </p>
                </div>
                <div className="p-8 bg-slate-900/30 border border-slate-800 rounded-3xl hover:border-blue-500/30 transition-all">
                    <TrendingUp className="w-10 h-10 text-blue-400 mb-6" />
                    <h3 className="text-xl font-bold text-white mb-3">Data-Driven Sales</h3>
                    <p className="text-slate-400 text-sm leading-relaxed">
