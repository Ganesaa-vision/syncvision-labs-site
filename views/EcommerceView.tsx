  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#0a0a0a] text-slate-900 dark:text-slate-200 font-sans selection:bg-yellow-500/30 transition-colors duration-300">
      ...
      <div className="pt-24 md:pt-32 pb-12 md:pb-20 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-32">
            ...
            <div className="p-10 bg-white dark:bg-slate-900/40 border border-slate-200 dark:border-slate-800 rounded-[2.5rem] hover:border-red-500/30 transition-all relative overflow-hidden group shadow-lg dark:shadow-none">
                ...
                <div className="relative z-10">
                    ...
                    <div className="text-2xl font-bold text-slate-900 dark:text-white mb-4">RM 499 <span className="text-sm text-slate-500 font-normal">/flat fee</span></div>
            ...
            <div className="p-10 bg-gradient-to-br from-yellow-50 to-slate-100 dark:from-yellow-900/20 dark:to-slate-900 border border-yellow-500/20 rounded-[2.5rem] flex flex-col justify-center shadow-lg dark:shadow-none">
                ...
                <div className="mb-8">
                    <label className="text-slate-600 dark:text-slate-400 text-sm font-mono uppercase tracking-widest mb-4 block">
                        Monthly Sales Volume: <span className="text-slate-900 dark:text-white font-bold">RM {monthlySales.toLocaleString()}</span>
                    </label>
                    <input 
                        type="range" 
                        min="0" 
                        ...
                        className="w-full h-2 bg-slate-300 dark:bg-slate-700 rounded-lg appearance-none cursor-pointer accent-yellow-500"
                    />
                </div>

                <div className="space-y-4 mb-8">
                    <div className="flex justify-between items-center p-4 bg-red-100 dark:bg-red-500/10 border border-red-200 dark:border-red-500/20 rounded-xl">
        ...
        {/* COMPARISON TABLE */}
        <div className="mb-32">
          <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12 text-center">The "No-Rent" Advantage</h2>
              ...
              <tbody className="text-sm text-slate-700 dark:text-slate-300">
                {[
                  ...
                  <tr key={i} className="group hover:bg-slate-100 dark:hover:bg-slate-900/30 transition-colors">
                    ...
                    <td className="p-6 border-b border-slate-200 dark:border-slate-800/50 font-mono text-red-500 dark:text-red-400">
                        {row.them}
                    </td>
                    <td className="p-6 border-b border-slate-200 dark:border-slate-800/50 font-mono bg-yellow-50 dark:bg-yellow-900/5 text-yellow-800 dark:text-yellow-100 font-bold">
        ...
        {/* CTA */}
        <div className="text-center p-12 bg-gradient-to-b from-slate-100 to-slate-200 dark:from-slate-900 dark:to-slate-950 rounded-[3rem] border border-slate-200 dark:border-slate-800">
