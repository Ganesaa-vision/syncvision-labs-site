  ...
  return (
    <div className="bg-slate-50 dark:bg-[#050505] min-h-screen text-slate-900 dark:text-slate-100 font-sans selection:bg-green-500/30 overflow-x-hidden transition-colors duration-300">
      ...
      <div className="fixed inset-0 w-full h-full pointer-events-none overflow-hidden">
          <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-green-500/5 dark:bg-green-500/5 rounded-full blur-[120px]" />
          <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-emerald-500/5 dark:bg-emerald-500/5 rounded-full blur-[120px]" />
      ...
      <div className="pt-24 md:pt-32 pb-12 md:pb-20 px-6 max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.div variants={itemVariants} className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-green-500/20 bg-green-50 dark:bg-green-500/5 text-green-600 dark:text-green-400 text-xs font-mono mb-8">
             <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
             SYSTEM_OVERRIDE_INITIATED
          </motion.div>
          
          <motion.h1 variants={itemVariants} className="text-4xl md:text-8xl font-black text-slate-900 dark:text-white tracking-tighter uppercase leading-[0.9] mb-10">
            We Are The <br/>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-20 md:mb-40">
           ...
           >
              ...
              <div className="relative bg-white/50 dark:bg-slate-900/50 border border-green-500/20 p-10 rounded-3xl backdrop-blur-sm shadow-lg dark:shadow-none">
           ...
           <motion.div
             ...
             className="space-y-8"
           >
              <div className="p-8 border-l-2 border-green-500/30 bg-slate-100 dark:bg-white/[0.02]">
        ...
        <div className="mb-40">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <motion.div 
                ...
                className="bg-white dark:bg-slate-900/30 border border-slate-200 dark:border-white/10 p-8 rounded-3xl hover:border-green-500/50 transition-colors duration-300 group relative overflow-hidden shadow-sm dark:shadow-none"
              >
              ...
              <motion.div 
                whileHover={{ y: -10, scale: 1.02 }}
                transition={{ type: "spring", stiffness: 300, damping: 20 }}
                className="bg-green-50 dark:bg-green-900/10 border border-green-500/20 p-8 rounded-3xl transition-colors duration-300 group relative overflow-hidden"
              >
                 ...
                 <p className="text-slate-700 dark:text-green-100/80 leading-relaxed">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-40 items-center">
           ...
           <div className="relative">
              ...
              <div className="relative bg-slate-100 dark:bg-slate-950 border border-green-500/20 rounded-3xl p-8 overflow-hidden">
        ...
        {/* 5. PROMISE & CTA */}
        <div className="relative rounded-[3rem] overflow-hidden bg-green-50 dark:bg-green-950/20 border border-green-500/20 p-12 md:p-24 text-center">
